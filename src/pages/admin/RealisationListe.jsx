...
export default function RealisationListe() {
    ...
    const deleteRealisation = (id) => {
        axios.delete(`${API_URL}realisations/delete/`+id,{
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
  ...
  <nav id="sidebarMenu" className="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
    ...
    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 className="h2">Realisation</h1>
        <div className="btn-toolbar mb-2 mb-md-0">

        <Link className='btn btn-primary' to={'/dashboard/realisation/ajouter'}>
        Ajouter Realisation
        </Link>
        </div>
      </div>
          ...
          <tbody>
            {
                data.map((item,index) => (
                    ...
                    <td><img
                     ...
                     height={100} width={100} alt="image"/></td>
                    <td>
                    <button onClick={() => deleteRealisation(item.id)} className='btn btn-danger'>Supprimer</button>
                    </td>
                  </tr>
                ))
            }
